...
class RecognitionService {
  ...
  Future<void> loadModel() async {
    ...
    try {
      ...
      if (!_looksLikeTfliteModel(modelBytes)) {
        _loadError =
            'assets/models/landmark_model.tflite is not a valid TFLite model.';
  ...
  bool _looksLikeTfliteModel(Uint8List bytes) {
  ...
  Future<List<DetectionResult>> predictAll(
    ...
    if (_loadError != null && _interpreter == null) return [];
